...
describe('Test to validate images are being resized and rendered with the right response', function () {
    it('gets the resize api endpoint with image rendered', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/resize?file=IMG_5194.jpg&width=200&height=200')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [2 /*return*/];
...
describe('Test endpoint responses for image placeholder on src', function () {
    it('gets the resize api endpoint with image rendered', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?filename=IMG_5194-resized-compressed.jpeg&width=200&height=200')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [2 /*return*/];
